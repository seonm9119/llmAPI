KEYVALUE_SYSTEM_PROMPT = """You are a visual document field-key extractor.
...
KEYVALUE_OUTPUT_SCHEMA_TEXT = '{"keys":["visible field label"],"warnings":[]}'


def build_keyvalue_user_prompt(image_filename):
